                                    ...
                                    <div className="card my-4">
                                        <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                            <div className="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                                                <h6 className="text-white text-capitalize ps-3">Release</h6>
                                            </div>
                                        </div>
                                        <div className="card-body px-0 pb-2">
                                            <div className="table-responsive p-0">
                                                <table className="table align-items-center mb-0">
                                                    <thead>
                                                        <tr>
                                                            <th className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Atwork</th>
                                                            <th className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Title</th>
                                                            <th className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">UPC</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <p className="text-xs font-weight-bold mb-0">Bholenath</p>
                                                            </td>
                                                            ...
                                                            <td className="align-middle ">
                                                                <p className="text-xs font-weight-bold mb-0">Umesh</p>
                                                            </td>

                                                            <td className="align-middle ">
                                                                <p className="text-xs font-weight-bold mb-0">23/04/18</p>
                                                            </td>
